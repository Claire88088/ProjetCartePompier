 ...
 */
final class Version20211125130731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element AS SELECT id, photo, texte, lien, date_deb, date_fin FROM element');
        $this->addSql('DROP TABLE element');
        $this->addSql('CREATE TABLE element (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_calque_id INTEGER DEFAULT NULL, type_element_id INTEGER DEFAULT NULL, icone_id INTEGER DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL COLLATE BINARY, texte VARCHAR(255) DEFAULT NULL COLLATE BINARY, lien VARCHAR(255) DEFAULT NULL COLLATE BINARY, date_deb DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL, CONSTRAINT FK_41405E393C2C4A3 FOREIGN KEY (type_calque_id) REFERENCES type_calque (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_41405E3921CFC01 FOREIGN KEY (type_element_id) REFERENCES type_element (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_41405E395A805D31 FOREIGN KEY (icone_id) REFERENCES icone (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO element (id, photo, texte, lien, date_deb, date_fin) SELECT id, photo, texte, lien, date_deb, date_fin FROM __temp__element');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element AS SELECT id, photo, texte, lien, date_deb, date_fin FROM element');
        $this->addSql('DROP TABLE element');
        $this->addSql('CREATE TABLE element (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, photo VARCHAR(255) DEFAULT NULL, texte VARCHAR(255) DEFAULT NULL, lien VARCHAR(255) DEFAULT NULL, date_deb DATETIME DEFAULT NULL, date_fin DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO element (id, photo, texte, lien, date_deb, date_fin) SELECT id, photo, texte, lien, date_deb, date_fin FROM __temp__element');
        $this->addSql('DROP TABLE __temp__element');
        $this->addSql('DROP INDEX IDX_C4C9AE45B70485B3');
        $this->addSql('DROP INDEX IDX_C4C9AE4584C36B66');
