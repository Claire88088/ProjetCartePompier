 ...
 */
final class Version20211125130358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__point AS SELECT id, longitude, latitude, rang FROM point');
        ...
        $this->addSql('INSERT INTO point (id, longitude, latitude, rang) SELECT id, longitude, latitude, rang FROM __temp__point');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__point AS SELECT id, longitude, latitude, rang FROM point');
        $this->addSql('DROP TABLE point');
        $this->addSql('CREATE TABLE point (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, rang SMALLINT NOT NULL)');
        $this->addSql('INSERT INTO point (id, longitude, latitude, rang) SELECT id, longitude, latitude, rang FROM __temp__point');
        $this->addSql('DROP TABLE __temp__point');
        $this->addSql('DROP INDEX IDX_6C24F39BB70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__travaux AS SELECT id, calque_id, date_debut, date_fin FROM travaux');
