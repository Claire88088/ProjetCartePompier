 ...
 */
final class Version20211119151512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, latitude, longitude FROM element_autoroute');
        ...
        $this->addSql('INSERT INTO element_autoroute (id, calque_id, latitude, longitude) SELECT id, calque_id, latitude, longitude FROM __temp__element_autoroute');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_er AS SELECT id, etablissement_repertorie_id, latitude, longitude FROM element_er');
        ...
        $this->addSql('INSERT INTO element_er (id, etablissement_repertorie_id, latitude, longitude) SELECT id, etablissement_repertorie_id, latitude, longitude FROM __temp__element_er');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__etablissement_repertorie AS SELECT id, calque_id, description, photo, lien FROM etablissement_repertorie');
        ...
        $this->addSql('INSERT INTO etablissement_repertorie (id, calque_id, description, photo, lien) SELECT id, calque_id, description, photo, lien FROM __temp__etablissement_repertorie');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__type_element_autoroute AS SELECT id, nom_typ FROM type_element_autoroute');
        $this->addSql('DROP TABLE type_element_autoroute');
        $this->addSql('CREATE TABLE type_element_autoroute (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_type VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO type_element_autoroute (id, nom_type) SELECT id, nom_typ FROM __temp__type_element_autoroute');
        $this->addSql('DROP TABLE __temp__type_element_autoroute');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, latitude, longitude FROM element_autoroute');
        $this->addSql('DROP TABLE element_autoroute');
        $this->addSql('CREATE TABLE element_autoroute (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, calque_id INTEGER DEFAULT NULL, latitude NUMERIC(10, 8) NOT NULL, longitude NUMERIC(10, 8) NOT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, adresse VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO element_autoroute (id, calque_id, latitude, longitude) SELECT id, calque_id, latitude, longitude FROM __temp__element_autoroute');
        $this->addSql('DROP TABLE __temp__element_autoroute');
        $this->addSql('CREATE INDEX IDX_C4C9AE45B70485B3 ON element_autoroute (calque_id)');
        $this->addSql('DROP INDEX IDX_477ED079FA20172D');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_er AS SELECT id, etablissement_repertorie_id, latitude, longitude FROM element_er');
        $this->addSql('DROP TABLE element_er');
        $this->addSql('CREATE TABLE element_er (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, etablissement_repertorie_id INTEGER DEFAULT NULL, latitude NUMERIC(10, 8) NOT NULL, longitude NUMERIC(10, 8) NOT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, adresse VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO element_er (id, etablissement_repertorie_id, latitude, longitude) SELECT id, etablissement_repertorie_id, latitude, longitude FROM __temp__element_er');
        $this->addSql('DROP TABLE __temp__element_er');
        $this->addSql('CREATE INDEX IDX_477ED079FA20172D ON element_er (etablissement_repertorie_id)');
        $this->addSql('DROP INDEX IDX_B170F90CB70485B3');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__etablissement_repertorie AS SELECT id, calque_id, description, photo, lien FROM etablissement_repertorie');
        $this->addSql('DROP TABLE etablissement_repertorie');
        $this->addSql('CREATE TABLE etablissement_repertorie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, calque_id INTEGER DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, lien VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, nom VARCHAR(255) DEFAULT NULL COLLATE BINARY, adresse VARCHAR(255) DEFAULT NULL COLLATE BINARY, latitude NUMERIC(10, 8) DEFAULT NULL, longitude NUMERIC(10, 8) DEFAULT NULL)');
        $this->addSql('INSERT INTO etablissement_repertorie (id, calque_id, description, photo, lien) SELECT id, calque_id, description, photo, lien FROM __temp__etablissement_repertorie');
        $this->addSql('DROP TABLE __temp__etablissement_repertorie');
        $this->addSql('CREATE INDEX IDX_B170F90CB70485B3 ON etablissement_repertorie (calque_id)');
        $this->addSql('DROP INDEX IDX_6C24F39BB70485B3');
        ...
        $this->addSql('DROP TABLE __temp__travaux');
        $this->addSql('CREATE INDEX IDX_6C24F39BB70485B3 ON travaux (calque_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__type_element_autoroute AS SELECT id, nom_type FROM type_element_autoroute');
        $this->addSql('DROP TABLE type_element_autoroute');
        $this->addSql('CREATE TABLE type_element_autoroute (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_typ VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO type_element_autoroute (id, nom_typ) SELECT id, nom_type FROM __temp__type_element_autoroute');
        $this->addSql('DROP TABLE __temp__type_element_autoroute');
    }
}
