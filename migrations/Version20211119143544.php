 ...
 */
final class Version20211119143544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_element_autoroute (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_typ VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE TABLE type_element_er (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_type VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('ALTER TABLE type_etablissment_repertorie ADD COLUMN nom_type VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE type_element_er');
        $this->addSql('DROP INDEX IDX_C4C9AE45B70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, type, adresse, latitude, longitude FROM element_autoroute');
        $this->addSql('DROP TABLE element_autoroute');
        ...
        $this->addSql('DROP TABLE __temp__travaux');
        $this->addSql('CREATE INDEX IDX_6C24F39BB70485B3 ON travaux (calque_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__type_etablissment_repertorie AS SELECT id FROM type_etablissment_repertorie');
        ...
        $this->addSql('INSERT INTO type_etablissment_repertorie (id) SELECT id FROM __temp__type_etablissment_repertorie');
        $this->addSql('DROP TABLE __temp__type_etablissment_repertorie');
    }
}
