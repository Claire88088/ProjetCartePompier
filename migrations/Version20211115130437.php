 ...
 */
final class Version20211115130437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_asaisir (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_er AS SELECT id, etablissement_repertorie_id, type, adresse, coordonnees_gps FROM element_er');
        ...
        $this->addSql('INSERT INTO element_er (id, etablissement_repertorie_id, type, adresse, coordonnees_gps) SELECT id, etablissement_repertorie_id, type, adresse, coordonnees_gps FROM __temp__element_er');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE type_asaisir');
        $this->addSql('DROP INDEX IDX_C4C9AE45B70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, type, adresse, coordonnees_gps FROM element_autoroute');
        $this->addSql('DROP TABLE element_autoroute');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_er AS SELECT id, etablissement_repertorie_id, type, adresse, coordonnees_gps FROM element_er');
        $this->addSql('DROP TABLE element_er');
        $this->addSql('CREATE TABLE element_er (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, etablissement_repertorie_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, coordonnees_gps VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO element_er (id, etablissement_repertorie_id, type, adresse, coordonnees_gps) SELECT id, etablissement_repertorie_id, type, adresse, coordonnees_gps FROM __temp__element_er');
        $this->addSql('DROP TABLE __temp__element_er');
        $this->addSql('CREATE INDEX IDX_477ED079FA20172D ON element_er (etablissement_repertorie_id)');
        $this->addSql('DROP INDEX IDX_B170F90CB70485B3');
