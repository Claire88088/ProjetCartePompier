 ...
 */
final class Version20211119142851 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_asaisir (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('CREATE TABLE type_etablissement_repertorie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_type VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('DROP INDEX IDX_C4C9AE45B70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, type, adresse, latitude, longitude FROM element_autoroute');
        $this->addSql('DROP TABLE element_autoroute');
