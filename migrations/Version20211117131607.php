 ...
 */
final class Version20211117131607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE type_etablissement_repertorie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom_type VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__travaux AS SELECT id, calque_id, date_debut, date_fin, latitude_debut, longitude_debut, latitude_fin, longitude_fin FROM travaux');
        ...
        $this->addSql('INSERT INTO travaux (id, calque_id, date_debut, date_fin, latitude_debut, longitude_debut, latitude_fin, longitude_fin) SELECT id, calque_id, date_debut, date_fin, latitude_debut, longitude_debut, latitude_fin, longitude_fin FROM __temp__travaux');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE type_etablissement_repertorie');
        $this->addSql('DROP INDEX IDX_C4C9AE45B70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, type, adresse, latitude, longitude FROM element_autoroute');
        $this->addSql('DROP TABLE element_autoroute');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__travaux AS SELECT id, calque_id, date_debut, date_fin, latitude_debut, longitude_debut, latitude_fin, longitude_fin FROM travaux');
        $this->addSql('DROP TABLE travaux');
        $this->addSql('CREATE TABLE travaux (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, calque_id INTEGER DEFAULT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, latitude_debut NUMERIC(10, 8) NOT NULL, longitude_debut NUMERIC(10, 8) NOT NULL, latitude_fin NUMERIC(10, 8) NOT NULL, longitude_fin NUMERIC(10, 8) NOT NULL)');
        $this->addSql('INSERT INTO travaux (id, calque_id, date_debut, date_fin, latitude_debut, longitude_debut, latitude_fin, longitude_fin) SELECT id, calque_id, date_debut, date_fin, latitude_debut, longitude_debut, latitude_fin, longitude_fin FROM __temp__travaux');
        $this->addSql('DROP TABLE __temp__travaux');
        $this->addSql('CREATE INDEX IDX_6C24F39BB70485B3 ON travaux (calque_id)');
    }
